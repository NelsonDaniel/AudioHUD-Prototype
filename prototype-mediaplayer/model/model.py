...
MODEL_PATH = os.path.join(dirname, 'checkpoint', 'prototype_model_v1')
...
def load_stat_dict():
    stat_dict = np.load(os.path.join(dirname, 'stat_dict.npy'), allow_pickle = True).item()
...
# Read Video
video_filename =  os.path.join(dirname, 'uploads', 'office-space-with-audio.mp4')
audio_filename =  os.path.join(dirname, 'temp_audio.wav')
