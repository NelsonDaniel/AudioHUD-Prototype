...
if __name__ == "__main__":
    ...
    # Returns one second of audio as np array
    def captureOneSec():
        ...
        stereo, sr = librosa.load(wav_data, sr=32000, mono=False)
        return stereo

    # Returns rounded down values in np array that are within the threshold
    def round_down(sec, threshold):
        
        # Extract values within threshold
        seg1 = (-threshold<sec[0]) & (sec[0]<threshold)
        seg2 = (-threshold<sec[1]) & (sec[1]<threshold)
